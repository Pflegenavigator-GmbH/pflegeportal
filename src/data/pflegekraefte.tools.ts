export type ToolCategory = 'documentation' | 'ai' | 'medication' | 'communication' | 'legal';
...
export const tools: Tool[] = [
  ...
  },
  {
    ...
    features: [
      'Sprachbasierte Verlaufsberichte',
      'Smarte Schichtübergabe',
      'Echtzeit-Dokumentations-Bypass',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'SIS-konforme Formulierungen',
      'Direkte Software-Schnittstelle',
    ],
  ...
  },
  {
    ...
    provider: 'CareCloud',
    description:
      'Intelligente, cloudbasierte Pflegedokumentation direkt aus der Praxis für den modernen Pflegeprozess.',
    features: [
      'Echtzeit-Synchronisation',
      'Intelligente Tourenführung',
      'Papierlose Prozessbegleitung',
    ],
  ...
  },
  {
    ...
    features: [
      'Umfangreiche Abrechnungsmodule',
  ...
  },
  {
    ...
    features: [
      'Zuverlässige Einnahmeerinnerung',
      'Detailliertes Einnahme-Tracking',
      'Exportierbare Medikationsberichte',
    ],
  ...
  },
  {
    ...
    features: [
      ...
      'Schnittstelle zu KIM-Diensten',
      'Sicherer Arzt-Pflege-Austausch',
    ],
  ...
  },
  {
    ...
    provider: 'ZQP',
    description:
      'Wissenschaftliches Recherche-Portal für pflegerische Qualitätsstandards, Leitlinien und Evidenzberichte.',
    features: [
      'Evidenzbasierte Standards',
      'Schnelle Leitlinien-Recherche',
      'Praxisnahe HTA-Berichte',
    ],
