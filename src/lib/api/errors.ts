...
export class PflegeNavigatorError extends Error {
  ...
  // LÖSUNG: 'unknown' statt 'any' für generische Objekte
  public readonly context?: Record<string, unknown>;

  constructor(details: ErrorDetails, context?: Record<string, unknown>) {
...
export class DatabaseError extends PflegeNavigatorError {
  ...
  constructor(message: string, originalError?: unknown) {
    super(
      ...
      {
        // Typsichere Prüfung: Nur wenn es wirklich ein Error-Objekt ist, greifen wir auf .message zu
        originalError:
