...
describe('BrevoClient', () => {
    ...
    describe('Initialisierung (Singleton)', () => {
        it('sollte einen Fehler werfen, wenn BREVO_API_KEY fehlt', () => {
            ...
            expect(() => BrevoClient.getInstance()).toThrow('BREVO_API_KEY fehlt in den Umgebungsvariablen.');
    ...
    describe('sendEmail', () => {
        ...
        it('sollte einen Fehler werfen, wenn die Brevo API einen Fehler meldet', async () => {
            ...
            await expect(client.sendEmail(mockEmailOptions)).rejects.toThrow('Brevo Email API Fehler: {"message":"Missing parameters","code":"bad_request"}');
