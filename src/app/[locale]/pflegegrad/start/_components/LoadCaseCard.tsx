...
export function LoadCaseCard({ onLoad, loading, externalError }: LoadCaseCardProps) {
    ...
    return (
        <Card className="bg-white/5 border-white/10 text-white shadow-xl">
            <CardHeader>
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <CardDescription className="text-gray-400">Haben Sie bereits einen Fallcode?</CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent className="space-y-4">
                <div className="space-y-2">
                    <Label htmlFor="caseCode" className="text-gray-300">Fallcode eingeben</Label>
                    <Input
                        id="caseCode"
                        type="text"
            ...
            <CardFooter>
                <Button onClick={handleSubmit} disabled={loading || !code.trim()} className="w-full border-white/10 text-white hover:bg-white/5 font-semibold" size="lg" variant="outline">
