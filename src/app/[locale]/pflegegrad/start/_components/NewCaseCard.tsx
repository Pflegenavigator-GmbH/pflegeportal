            ...
            <CardHeader>
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <CardDescription className="text-gray-400">Speichern Sie diesen Code gut ab</CardDescription>
                    </div>
                </div>
            </CardHeader>
            <CardContent className="space-y-4">
                ...
                <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-4 flex gap-3 items-start">
                    ...
                    <p className="text-sm text-amber-300">
                        <strong>Wichtig:</strong> Notieren Sie sich diesen Code. Damit können Sie die Befragung jederzeit unterbrechen und an jedem Gerät kostenfrei fortsetzen.
                    </p>
                </div>
            </CardContent>
            <CardFooter>
                <Button onClick={onActivate} className="w-full bg-emerald-600 hover:bg-emerald-500 text-white font-semibold" size="lg">
