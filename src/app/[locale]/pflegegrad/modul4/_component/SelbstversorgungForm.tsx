...
export function SelbstversorgungForm({ fragen, optionen, antworten, onAntwort }: SelbstversorgungFormProps) {
    return (
        <div className="space-y-6">
            {fragen.map((frage) => (
                <Card key={frage.id} className="bg-white/5 border-emerald-500/10 text-white shadow-xl hover:border-emerald-500/20 transition-colors">
