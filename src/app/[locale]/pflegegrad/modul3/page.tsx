...
const VERHALTEN_FRAGEN: Frage[] = [
  { id: "m3_1", text: "Motorisch geprägte Verhaltensweisen", hilfe: "Z.B. zielloses Herumlaufen, Aufstehen und Niedersetzen, Weglauf-Tendenzen." },
  { id: "m3_2", text: "Nächtliche Unruhe", hilfe: "Wird der Tag-Nacht-Rhythmus gestört? Gibt es nächtliches Umherwandern oder Rufen?" },
  { id: "m3_3", text: "Selbstschädigendes und autoaggressives Verhalten", hilfe: "Z.B. Kratzen, Schlagen gegen Gegenstände, Verweigerung von Nahrung/Flüssigkeit." },
  { id: "m3_4", text: "Abwehr von pflegerischen Maßnahmen", hilfe: "Gibt es verbalen oder physischen Widerstand bei der Körperpflege oder beim Ankleiden?" }
];
  ...
  return (
      <div className="container mx-auto px-4 py-8 max-w-2xl text-white">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Gewichtung: 15% (Vergleichs-Fusing mit Modul 2)</p>
              </div>
            </div>
            {caseCode && (
        ...
        <div className="mt-8 pt-6 border-t border-white/10 flex items-start gap-3 text-gray-400 text-xs leading-relaxed">
          ...
          <p>
            <strong>Wichtiger rechtlicher Hinweis:</strong> Die im Modul 3 erfassten Kriterien spiegeln psychische Problemlagen wider. Sie fließen über das Höchstwert-Prinzip direkt in die Ermittlung des Pflegegrads ein.
          </p>
        </div>
      </div>
  );
