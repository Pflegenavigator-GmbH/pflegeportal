            ...
            <CardContent className="p-6 pt-0">
                <ul className="grid gap-3">
                    {ergebnis.recommendations.map((empfehlung, index) => (
                        <li key={index} className="flex items-start gap-3 p-3 bg-white/[0.02] border border-white/5 rounded-xl text-sm leading-relaxed text-gray-200">
                    ...
                    {ergebnis.trafficLight === 'gelb' && (
                        <li className="flex items-start gap-3 p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl text-sm leading-relaxed text-amber-400">
                            ...
                            <span>
                <strong>Grenzbereich-Warnung:</strong> Ihr Ergebnis liegt haarscharf an der Grenze. Legen Sie dem Antrag ein detailliertes Pflegetagebuch bei, um Streichungen durch den Gutachter proaktiv abzuwehren.
              </span>
                        </li>
                    )}
                </ul>
