...
export function KrankheitsbewaeltigungForm({ fragen, optionen, antworten, onAntwort }: KrankheitsbewaeltigungFormProps) {
    return (
        <div className="space-y-6">
            {fragen.map((fr) => (
                <Card key={fr.id} className="bg-white/5 border-rose-500/10 text-white shadow-xl hover:border-rose-500/20 transition-colors">
