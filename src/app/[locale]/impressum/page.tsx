            ...
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <Card className="border-amber-500/20 bg-amber-500/5 text-white shadow-xl">
                    ...
                    <CardContent className="pt-4 space-y-4 text-xs text-gray-300 leading-relaxed">
                        <p>
                            <strong>Keine Rechtsberatung:</strong> Die PflegeNavigator EU gUG bietet keine Rechtsberatung,
                            keine medizinische Beratung und keine verbindliche Auskunft über Leistungsansprüche.
                            Die automatisierten Auswertungen sind als reine Orientierungshilfen zu verstehen.
                        </p>
                        <p>
                            <strong>Keine Garantie:</strong> Verbindliche und rechtskräftige Entscheidungen im Einzelfall
                            treffen ausschließlich die zuständigen staatlichen Stellen und Leistungsträger (Medizinischer Dienst, Pflegekassen, etc.).
                        </p>
                    </CardContent>
                </Card>
