    ...
    return (
        ...
        <NextIntlClientProvider messages={messages} locale={locale}>
            ...
            <footer className="bg-[#0f2744] border-t border-white/10 py-8 px-4 mt-auto">
                <div
                    className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
                    <div>
                    ...
                    <div className="flex flex-wrap gap-4 md:gap-6 justify-center">
                        ...
                        <a href={`/${locale}/datenschutz`}
                           className="hover:text-white transition-colors">Datenschutz</a>
                        <a href={`/${locale}/agb`} className="hover:text-white transition-colors">AGB</a>
                    </div>
                </div>
            </footer>
