...
export const gdbSektoren: GdBSektor[] = [
    {
        ...
        werte: [
            ...
            { label: 'Mittelgradige Einschränkung (z.B. zwei Wirbelsäulenabschnitte, Arthrose)', wert: 30 },
    ...
    },
    {
        ...
        werte: [
            ...
            { label: 'Stärker behindernde Störungen (Erhebliche familiäre/berufliche Einbußen)', wert: 40 },
            { label: 'Schwere Störungen (Vollständiger sozialer Rückzug / Geistige Behinderung)', wert: 70 },
        ]
    },
    {
        id: 'herz_kreislauf',
