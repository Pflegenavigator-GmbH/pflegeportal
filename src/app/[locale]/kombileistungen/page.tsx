            ...
            <div className="container mx-auto max-w-4xl space-y-8">
                            ...
                            <div className="flex items-start gap-3">
                                ...
                                <div className="flex-1">
                                    ...
                                    <CardDescription className="text-gray-300 text-xs sm:text-sm mt-1.5 leading-relaxed">
                                        Ab Pflegegrad 2 können Sie Pflegegeld und Sachleistungen (ambulanter Pflegedienst) flexibel mischen.
                                        Wichtig: Sie erhalten nur das anteilige Pflegegeld für den Prozentsatz, den Sie bei den Sachleistungen <strong>nicht</strong> verbraucht haben.
                                    </CardDescription>
                                </div>
                            </div>
                        </CardHeader>
                ...
                <Card className="bg-white/5 border-white/10 text-white shadow-xl">
                    <CardHeader className="border-b border-white/5 pb-4">
                        <CardTitle className="text-lg font-bold text-white">Welcher Pflegegrad liegt vor?</CardTitle>
                    </CardHeader>
                    <CardContent className="pt-5">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                            {pflegegrade.map((pg) => (
                                ...
                                >
                                    <div className={`text-2xl font-bold ${selectedPG === pg.pg ? 'text-[#20b2aa]' : 'text-gray-300'}`}>
                                        {pg.pg}
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <div className="text-[10px] font-bold text-[#20b2aa] mt-1.5 uppercase tracking-wide">
                                                {option.prozent === 100 ? 'Voller Anspruch (100%)' : `Anteilig (${option.prozent}%)`}
                                            </div>
                                        </div>
                                        {gewaehlteOptionen.includes(option.name) && (
                ...
                {/* Ergebnis */}
                <Card className={`shadow-2xl transition-colors ${ueberschritten ? 'bg-rose-500/10 border-rose-500/30' : 'bg-white/5 border-white/10'}`}>
                    <CardHeader className={`border-b pb-4 ${ueberschritten ? 'border-rose-500/20' : 'border-white/5'}`}>
                    ...
                    <CardContent className="pt-6 space-y-6">
                        ...
                        <div className="text-center">
                            <div className={`text-4xl sm:text-5xl font-extrabold tracking-tight ${ueberschritten ? 'text-rose-400' : 'text-white'}`}>
                        ...
                        {ueberschritten ? (
                            <div className="bg-rose-500/20 border border-rose-500/30 text-rose-300 p-4 rounded-xl text-center text-sm">
                                <strong>⚠️ Kombinationsgrenze überschritten!</strong><br />
                                Die theoretische Leistung übersteigt den Rahmen um {(aktuelleSumme - maxBetrag).toFixed(2)} €. Die Pflegekasse wird dies anteilig kürzen.
                            </div>
                        ) : restBudget > 0 ? (
                            <div className="bg-blue-500/10 border border-blue-500/20 text-blue-300 p-4 rounded-xl text-sm">
                                <strong>💡 Optimierungs-Tipp:</strong> Sie schöpfen Ihr Budget noch nicht voll aus. Es verbleibt ein Puffer von {restBudget.toFixed(2)} €, der für zusätzliche Sachleistungen genutzt werden kann.
                            </div>
                        ) : (
                        ...
                        <div className="border-t border-white/5 pt-4">
                            ...
                            <ul className="space-y-2">
                                {gewaehlteOptionen.map((name) => {
                                    ...
                                    return (
                                        <li key={name} className="flex justify-between items-center text-sm text-gray-300 bg-slate-950/30 p-2.5 rounded-lg border border-white/5">
                                            <span className="flex items-center gap-2">{option?.emoji} {name}</span>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    <Card className="bg-white/5 border-white/10 text-white hover:bg-white/[0.07] transition-colors">
                        ...
                        <CardContent>
                            <p className="text-gray-400 text-xs leading-relaxed">
                                Der Pflegedienst rechnet direkt mit der Kasse ab. Nutzen Sie dies nicht voll, wird das Pflegegeld anteilig an Sie ausgezahlt.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-white/5 border-white/10 text-white hover:bg-white/[0.07] transition-colors">
                        ...
                        <CardContent>
                            <p className="text-gray-400 text-xs leading-relaxed">
                                Ideal für Urlaub oder Krankheit der Pflegeperson. Der Anspruch beträgt bis zu 42 Tage im Kalenderjahr (separates Budget).
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-white/5 border-white/10 text-white hover:bg-white/[0.07] transition-colors">
                        ...
                        <CardContent>
                            <p className="text-gray-400 text-xs leading-relaxed">
                                Teilstationäre Betreuung am Tag. Dieses Budget wird oft <strong>zusätzlich</strong> gewährt und kürzt das Pflegegeld nicht zwingend!
                            </p>
                        </CardContent>
                    </Card>
                </div>
