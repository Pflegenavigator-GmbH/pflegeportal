        ...
        <main className="min-h-screen bg-slate-900 text-white py-12 px-4 font-sans">
            <div className="container mx-auto max-w-2xl space-y-6">
                ...
                <div className="text-center mb-4">
                    ...
                    <p className="text-xs text-gray-400 mt-1">Fordern Sie die vollständigen, lokal und serverseitig hinterlegten Maschinen-Datensätze Ihrer Akte an</p>
                </div>
                ...
                {!submitted ? (
                    <Card className="bg-white/5 border-white/10 text-white shadow-xl">
                        <CardHeader className="border-b border-white/5 pb-4">
                            ...
                            <CardTitle className="text-base font-bold text-white">Verfahrensdaten eingeben</CardTitle>
                        </CardHeader>
                                ...
                                {step === 1 ? (
                                    <div className="space-y-4">
                                        <div className="space-y-1.5">
                                            <label className="text-xs text-gray-300 font-medium">Zugeordneter Fallcode (z.B. PF-ABC123)</label>
                                            <Input
                                                type="text"
                                        ...
                                        <Button type="button" className="w-full h-11 bg-[#20b2aa] hover:bg-[#3ddbd0] text-slate-950 font-bold" disabled={!formData.fallcode || formData.fallcode.length < 4} onClick={() => setStep(2)}>
                                    ...
                                    <div className="space-y-4">
                                        <div className="space-y-1.5">
                                            <label className="text-xs text-gray-300 font-medium">Zustelladresse für verschlüsseltes Daten-Dossier (E-Mail)</label>
                                            <Input
                                                type="email"
                                        ...
                                        <div className="bg-slate-950/40 border border-white/5 p-4 rounded-xl flex items-start gap-3">
                                            ...
                                            />
                                            <label htmlFor="legal-confirm" className="text-xs text-gray-400 leading-relaxed cursor-pointer">
                                                Ich versichere eidesstattlich, dass ich Inhaber dieses Fallcodes bin oder eine rechtsgültige Vollmacht des Betroffenen vorliegt.
                                            </label>
                                        </div>
                                        <div className="flex gap-2 pt-2">
                                            <Button type="button" variant="outline" onClick={() => setStep(1)} className="border-white/10 text-white hover:bg-white/5 h-11">
                                                <ArrowLeft className="mr-1.5 w-4 h-4" /> Zurück
                                            </Button>
                                            <Button type="submit" disabled={!formData.email || !formData.bestaetigung || loading} className="flex-1 h-11 bg-[#20b2aa] hover:bg-[#3ddbd0] text-slate-950 font-bold">
                    ...
                    <Card className="border-emerald-500/20 bg-emerald-500/5 text-white shadow-xl">
                        <CardHeader className="border-b border-white/5">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle className="text-emerald-400 text-base font-bold">Antrag revisionssicher eingegangen!</CardTitle>
                                    <CardDescription className="text-gray-400 text-xs">Gesetzliche Bearbeitungsfrist nach Art. 12 Abs. 3 DSGVO läuft</CardDescription>
                                </div>
                            </div>
                        </CardHeader>
                        <CardContent className="pt-4 space-y-3 text-xs text-gray-300">
                            <p className="flex items-center gap-2"><Mail className="w-4 h-4 text-emerald-400" /> <span>E-Mail-Protokoll hinterlegt für: {formData.email}</span></p>
                            <p className="flex items-center gap-2"><Clock className="w-4 h-4 text-emerald-400" /> <span>Maximale Bearbeitungsdauer: 30 Tage (Regelfall deutlich schneller)</span></p>
                            <Button variant="outline" onClick={() => router.push(`/${locale}/datenschutz`)} className="w-full h-10 border-white/10 text-white hover:bg-white/5 mt-2">Zurück zur Übersicht</Button>
                        </CardContent>
                    </Card>
                )}
                ...
                <Card className="bg-white/5 border-white/10 text-white shadow-md">
                    <CardHeader className="p-4 pb-2">
                        <CardTitle className="text-xs font-bold flex items-center gap-2 text-gray-300">
                            <Database className="w-4 h-4 text-[#20b2aa]" /> Gesetzlicher Rechte-Spiegel (Kapitel 3 DSGVO)
                        </CardTitle>
                    </CardHeader>
