...
import { Shield, Lock, Eye, Server, User, Mail, FileText, ArrowRight, ArrowLeft, Trash2 } from 'lucide-react';
        ...
        <div className="min-h-screen bg-slate-900 text-white font-sans py-12 px-4">
            <div className="max-w-3xl mx-auto space-y-8">
                ...
                <div className="text-center space-y-3">
                    ...
                    <p className="text-gray-400 text-sm">Verschlüsselte In-Memory Verarbeitung nach EU-Standard (DSGVO)</p>
                </div>
                ...
                <Card className="bg-white/5 border-white/10 text-white shadow-xl">
                    ...
                    <CardContent className="pt-4 space-y-2 text-xs sm:text-sm text-gray-300">
                        <p className="flex items-start gap-2">
                            ...
                            <span>Anonyme Fall-Musterung: Speicherung erfolgt ausschließlich über einen **zufälligen Code** (z.B. PF-ABC123).</span>
                        </p>
                        <p className="flex items-start gap-2">
                            <span className="text-[#20b2aa]">✓</span>
                            <span>Geografische Isolation: Infrastruktur gehostet auf ISO-27001-zertifizierten Servern in **Frankfurt, Deutschland**.</span>
                        </p>
                        <p className="flex items-start gap-2">
                            <span className="text-[#20b2aa]">✓</span>
                            <span>Zweckbindung: Keine kommerzielle Datenweitergabe, kein Tracking, kein Werbe-Verkauf.</span>
                        </p>
                    </CardContent>
                </Card>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <Card className="bg-white/5 border-white/10 text-white shadow-md hover:bg-white/[0.08] transition-all cursor-pointer" onClick={() => router.push(`/${locale}/datenschutz/auskunft`)}>
                    ...
                    <Card className="bg-white/5 border-white/10 text-white shadow-md hover:bg-white/[0.08] transition-all cursor-pointer" onClick={() => router.push(`/${locale}/datenschutz/loeschen`)}>
                        <CardContent className="p-5 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                ...
                <Card className="bg-white/5 border-white/10 text-white shadow-xl">
                    ...
                    <CardContent className="text-xs text-gray-300 space-y-1">
                        ...
                        <p className="flex items-center gap-1.5 pt-2">
                            ...
                            <a href="mailto:datenschutz@pflegenavigatoreu.com" className="text-[#20b2aa] hover:underline">datenschutz@pflegenavigatoreu.com</a>
                        </p>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-white/5 border-white/10 text-white shadow-xl">
                    ...
                    <CardContent className="space-y-4 text-xs text-gray-300">
                        <div className="bg-slate-950/40 border border-white/5 p-4 rounded-xl">
                            <p className="font-bold text-white mb-2">Bei Nutzung des digitalen Pflegegrad-Rechners:</p>
                        ...
                        <div className="bg-emerald-500/10 border border-emerald-500/20 p-4 rounded-xl text-emerald-400">
                            ...
                            <p className="text-gray-300">Es werden ohne Ihre explizite Freigabe im Rechner-Trichter keine Namen, Versicherungsnummern oder Klarschriften verarbeitet.</p>
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card className="bg-white/5 border-white/10 text-white shadow-xl">
                    ...
                    <CardContent className="text-xs text-gray-300 space-y-2">
                        <p>Die Verarbeitung erfolgt auf Servern der Supabase Inc. am geschützten deutschen Netzknoten-Standort (AWS Frankfurt Registry), vollständig isoliert vom US-Mutterkonzern (EU-Data-Boundary-Standard).</p>
                    </CardContent>
                </Card>
