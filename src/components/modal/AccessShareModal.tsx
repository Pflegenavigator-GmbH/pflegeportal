...
import { Mail, Smartphone, Download, Loader2, MessageCircle, Share2, ShieldAlert } from 'lucide-react';
        ...
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="bg-[#0f2744] text-white border-white/10 sm:max-w-md p-0 overflow-hidden">
                    ...
                    <div className="mt-6">
                        ...
                        <div className="mt-3 flex items-start gap-2 rounded-xl border border-white/5 bg-slate-950/40 p-3 text-slate-400">
                            ...
                            <p className="text-[11px] leading-relaxed">
                                <strong className="text-amber-500">Eigenverantwortung:</strong> Dieser Button öffnet das Nachrichten-Programm Ihres eigenen Geräts. Bitte teilen Sie den Link ausschließlich mit Personen Ihres Vertrauens.
                            </p>
                        </div>
                    </div>
              ...
              nicht
                            ...
                            in unserer Datenbank gespeichert. Sie werden ausschließlich für diesen einmaligen Versand genutzt.
                        </p>
                    </div>
                </div>
            </DialogContent>
