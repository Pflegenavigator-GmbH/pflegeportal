                ...
                <Card className="bg-slate-900 border-white/10 text-white shadow-2xl overflow-hidden">
                    ...
                    <CardHeader className="border-b border-white/5 bg-white/[0.01] flex flex-row items-center justify-between p-4 sm:p-6">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <CardTitle className="text-lg font-bold text-white">Amtliche Druckvorschau (DIN 5008)</CardTitle>
                                <CardDescription className="text-xs text-gray-400">Verfahrenskorrespondenz Akte: {caseCode?.toUpperCase() || 'LOKAL'}</CardDescription>
                            </div>
                        </div>
                        <button onClick={onClose} className="p-1.5 hover:bg-white/5 text-gray-400 hover:text-white rounded-lg transition-colors">
                            <X className="w-5 h-5" />
                        </button>
                    </CardHeader>
                        ...
                        >
                            ...
                            <div className="flex justify-between items-start border-b-2 border-[#20b2aa] pb-4 mb-8">
                                <div>
                                    ...
                                    <p className="text-[10px] text-gray-500 font-medium tracking-wide uppercase mt-0.5">Offizieller Dokumenten-Generator</p>
                                </div>
                    ...
                    <CardFooter className="border-t border-white/5 bg-white/[0.01] p-4 flex flex-col sm:flex-row gap-3">
                        ...
                        <div className="flex gap-2 w-full sm:w-auto">
                            <Button variant="outline" onClick={onClose} className="flex-1 sm:flex-none border-white/10 text-white hover:bg-white/5 h-11 px-5">
                                Schließen
                            </Button>
                            <Button
